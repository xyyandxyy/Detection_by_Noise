...
parser.add_argument('--image', type=str, default="/remote-home/xujunhao/noise_detect/TruFor/test_docker/images/test_simswap.png", help='input image')
parser.add_argument('--output', type=str, default="/remote-home/xujunhao/noise_detect/TruFor/test_docker/output/test_simswap.png.npz",help='output file')
parser.add_argument('--mask', type=str, default='', help='ground truth mask (optional)')
args = parser.parse_args()

image_path  = args.image
image_name = Path(image_path).with_suffix("").name
