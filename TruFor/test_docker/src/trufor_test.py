...
def plot_result(result, image_path):
    ...
    # plt.show()
    plt.savefig(f'/remote-home/xujunhao/noise_detect/TruFor/test_docker/output_pic/{image_name}.png')
